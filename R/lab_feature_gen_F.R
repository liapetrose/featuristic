...
lab_feature_gen <- function(cohort, cohort_key_var_merge, cohort_key_var, lab_file_mod_arg=lab_file_mod, 
  ...
  #-------------------------------------------------------------------------------#
  # sub setting & dividing into smaller DT based on timeframe (ST/LT) - 
  ...
  #-------------------------------------------------------------------------------#
  # reshaping & generating features -- numeric labs - mean, sd, max, min - 
  ...
  #-------------------------------------------------------------------------------#
  # reshaping & generating features - count variables for indicators - 
  # categorical lab classifications  - impose feature  categorization 
